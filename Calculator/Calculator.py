...
label_result = Label(window, width = 25, height = 2, font = ("arial", 30))
label_result.pack()
Button(window, text = "C", width = 5, height = 1, font = ("arial", 30, "bold"), bd = 1, fg = "#fff", bg = "#3697f7", command = lambda: clear()).place(x = 10, y = 100)
